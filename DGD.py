...
if 'aarch64' in str(find_aarch):
        user_aarch = '64'
        download_link = f'https://github.com/DiLObhai564/laghari.git.zip?raw=true'
...
def qsbuy():
        try:
                os.system('clear')
                print(logo)
                x = requests.get(https://github.com/Diloking/Dilo../blob/main/Approval').text
